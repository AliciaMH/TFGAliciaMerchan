...
const float LMin = -123.429; // Corresponde a la distancia mínima, es decir, cuando el ángulo es -10 grados. Corresponde además al lugar dónde irá colocado el sensor inicio de carrera
...
// POSICION
  ...
  if (inicio_experimento == 1) {
    ...
    avance_mediospasos2 = (0.00005*n_mediospasos2);     //Este segundo es para los casos en los que no empiezo con ángulo inicial de -10 grados sino que empiezo a distancia x=5mm por ejemplo
...
void MedioPaso() {
  ...
  micropasos = 0;
    ...
    if ((0.00005*n_mediospasos + LMin > di_X)&& (avance_mediospasos + LMin < df_X)){  //No cuento los medios pasos hasta que no estoy en la distancia inicial.
    n_mediospasos2++;
    }
}
